...
from agent.tool_registry import execution_agent_tools
from agent.prompts import get_worker_system_prompt, get_execution_agent_prompt
...
class ExecutionAgent:
    ...
    def run_subtask(
        ...
        self.prompt = get_execution_agent_prompt(
            self.user_query,
            self.plan,
            self.run_number,
            memories,
