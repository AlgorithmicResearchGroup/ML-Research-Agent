...
from agent.tool_registry import coding_agent_tools
from agent.prompts import get_worker_system_prompt, get_coding_agent_prompt
...
class CodingAgent:
    ...
    def run_subtask(
        ...
        self.prompt = get_coding_agent_prompt(
            self.user_query,
            self.plan,
            self.run_number,
            memories,
